...
def parse_args():
    ...
    parser.add_argument("--run_name", type=str, default="fine_tuned_MedSAM", help="run model name")
    # parser.add_argument("--run_name", type=str, default="UASI_SAM", help="run model name")
    # parser.add_argument("--run_name", type=str, default="SAM_SIS_1", help="run model name")
    ...
    # parser.add_argument("--checkpoint", type=str, default="./work_dir/models/MedSAM_unet_adapter_SIS_25epo/epoch12_sam.pth",help="sam checkpoint")
    # parser.add_argument("--checkpoint", type=str, default="./work_dir/models_endovis_2018/MedSAM_adapter_25epo/epoch20_sam.pth", help="sam checkpoint")
    parser.add_argument("--checkpoint", type=str, default="/home3/yuchu/MedSAM/work_dir/models/MEDSAM_BOX/epoch12_sam.pth",help="sam checkpoint")
    # parser.add_argument("--checkpoint", type=str, default="./work_dir/SAMMED2D/sam-med2d_b.pth", help="sam checkpoint")
